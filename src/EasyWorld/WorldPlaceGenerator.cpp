    ...
    const float &roomcontainer_height)
{
    ...
    new_boundary_line.room_name_vec.resize(room_num, "Auto Generate WallRoom");
    ...
    std::vector<std::string> wallroom_name_vec;
    wallroom_name_vec.resize(room_num, "Auto Generate WallRoom");
