...
def get_args():
    ...
    parser.add_argument('--task', type=str, default='CustomEnv_20211224')
    ...
    parser.add_argument('--logdir', type=str, default='./log/TS_PPO')
...
def test_ppo(args=get_args()):
    ...
    train_envs = SubprocVectorEnv(
        [lambda: make_env(i) for i in range(args.training_num)]
    )
